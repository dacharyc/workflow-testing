...
- The SRV connection scheme has the form:
  ...
  .. literalinclude:: /untested-examples/includes/fact-connection-strings-atlas/1.txt
     :language: text
...
- The standard URI connection scheme has the form:
  ...
  .. literalinclude:: /untested-examples/includes/fact-connection-strings-atlas/2.txt
     :language: text
