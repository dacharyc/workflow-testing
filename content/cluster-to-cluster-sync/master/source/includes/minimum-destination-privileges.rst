.. list-table::
   ...
   * - Reversing
     - Everything from the default source privileges and the default destination
       ...
       .. literalinclude:: /untested-examples/includes/minimum-destination-privileges/2.js
          :language: javascript
   ...
   * - Multiple Reversals
     - Everything from the default source privileges and the default destination
       ...
       .. literalinclude:: /untested-examples/includes/minimum-destination-privileges/3.js
          :language: javascript
