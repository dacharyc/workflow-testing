...
- The SRV connection scheme has the form:
  ...
  .. literalinclude:: /untested-examples/includes/fact-connection-strings-onprem/1.txt
     :language: text

- The standard URI connection scheme has the form:

  .. literalinclude:: /untested-examples/includes/fact-connection-strings-onprem/2.txt
     :language: text
