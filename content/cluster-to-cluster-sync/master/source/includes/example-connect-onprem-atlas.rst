...
.. literalinclude:: /untested-examples/includes/example-connect-onprem-atlas/1.sh
   :language: shell
...
.. literalinclude:: /untested-examples/includes/example-connect-onprem-atlas/2.sh
   :language: shell
