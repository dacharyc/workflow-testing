...
.. literalinclude:: /untested-examples/includes/example-connect-onprem-to-atlas/1.sh
   :language: shell

The generic connection string format for the Atlas cluster is: 

.. literalinclude:: /untested-examples/includes/example-connect-onprem-to-atlas/2.sh
   :language: shell

Use the connection information you gathered for the self-managed cluster
to create the connection strings for ``cluster0``:

.. literalinclude:: /untested-examples/includes/example-connect-onprem-to-atlas/3.txt
   :language: text
...
.. literalinclude:: /untested-examples/includes/example-connect-onprem-to-atlas/4.sh
   :language: shell
...
.. literalinclude:: /untested-examples/includes/example-connect-onprem-to-atlas/5.sh
   :language: shell
...
.. literalinclude:: /untested-examples/includes/example-connect-onprem-to-atlas/6.sh
   :language: shell
