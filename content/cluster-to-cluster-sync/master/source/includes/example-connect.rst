...
.. literalinclude:: /untested-examples/includes/example-connect/1.sh
   :language: shell

Use the connection information you gathered to create the connection
strings for ``cluster0`` and ``cluster1``:

.. literalinclude:: /untested-examples/includes/example-connect/2.sh
   :language: shell
...
.. literalinclude:: /untested-examples/includes/example-connect/3.sh
   :language: shell
...
.. literalinclude:: /untested-examples/includes/example-connect/4.sh
   :language: shell
