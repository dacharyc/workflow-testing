...
.. literalinclude:: /untested-examples/includes/example-connect-atlas-to-atlas/1.sh
   :language: shell
...
.. literalinclude:: /untested-examples/includes/example-connect-atlas-to-atlas/2.sh
   :language: shell
...
.. literalinclude:: /untested-examples/includes/example-connect-atlas-to-atlas/3.sh
   :language: shell
...
.. literalinclude:: /untested-examples/includes/example-connect-atlas-to-atlas/4.sh
   :language: shell
...
.. literalinclude:: /untested-examples/includes/example-connect-atlas-to-atlas/5.sh
   :language: shell
